 ...
 *     使用说明：开启对应的定时器就能在主函数中调用相对应的中断    
              ...
              还可以修改是否开启中断
              还可以修改对应的抢占优先级和响应优先级
              该代码默认配置中断分组为 NVIC_PriorityGroup_2
 *
 *
 *
 */
#define TIM1_SWITCH   0                        /* 定时器1的开关 */
#define TIM1_NVIC_SWITCH  0                    /* 中断的开关 */
#define TIM2_SWITCH   0                    
#define TIM2_NVIC_SWITCH  0                    /* 中断的开关 */
#define TIM3_SWITCH   0
#define TIM3_NVIC_SWITCH  0                    /* 中断的开关 */
#define TIM4_SWITCH   0
#define TIM4_NVIC_SWITCH  0                    /* 中断的开关 */
#define TIM5_SWITCH   0
#define TIM5_NVIC_SWITCH  0                    /* 中断的开关 */
#define TIM6_SWITCH   1
#define TIM6_NVIC_SWITCH  1                    /* 中断的开关 */
#define TIM7_SWITCH   0
#define TIM7_NVIC_SWITCH  0                    /* 中断的开关 */
#define TIM8_SWITCH   0
#define TIM8_NVIC_SWITCH  0                    /* 中断的开关 */
...
/* TIM6 的配置项 */
    ...
    #define TIM6_NVIC_PRE  2                /* 抢占优先级 */
    #define TIM6_NVIC_SUB  5                /* 响应优先级 */
#endif
